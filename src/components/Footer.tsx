                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
                    <div className="col-span-2 lg:col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold text-gray-900">Awn عَوْن</span>
                        </div>
                        <p className="text-sm text-gray-500 max-w-xs leading-relaxed">
                            Empowering communities through transparent giving, volunteerism, and sustainable impact.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link to="/about" className="text-sm text-gray-600 hover:text-primary">Mission</Link></li>
                            <li><Link to="/about" className="text-sm text-gray-600 hover:text-primary">Impact</Link></li>
                            <li><Link to="/partners" className="text-sm text-gray-600 hover:text-primary">Partners</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link to="/accessibility" className="text-sm text-gray-600 hover:text-primary">Accessibility</Link></li>
                        </ul>
                    </div>
                </div>
