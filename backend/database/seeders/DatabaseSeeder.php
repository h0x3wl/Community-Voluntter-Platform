...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $badges = collect([
            ...
            ['code' => 'bronze_supporter', 'name' => 'Bronze Supporter', 'description' => 'Donated a total of $100 or more. Your generosity matters!', 'criteria_type' => 'donation_total', 'criteria_value' => 10000, 'min_points' => 100, 'display_order' => 2],
            ['code' => 'silver_supporter', 'name' => 'Silver Supporter', 'description' => 'Donated a total of $500 or more. A true force for good.', 'criteria_type' => 'donation_total', 'criteria_value' => 50000, 'min_points' => 500, 'display_order' => 3],
            ['code' => 'gold_supporter', 'name' => 'Gold Supporter', 'description' => 'Donated a total of $1,000 or more. An extraordinary impact.', 'criteria_type' => 'donation_total', 'criteria_value' => 100000, 'min_points' => 1000, 'display_order' => 4],
            ['code' => 'philanthropist', 'name' => 'Philanthropist', 'description' => 'Donated a total of $5,000 or more. A legendary contributor.', 'criteria_type' => 'donation_total', 'criteria_value' => 500000, 'min_points' => 5000, 'display_order' => 5],
            ['code' => 'frequent_donor', 'name' => 'Frequent Donor', 'description' => 'Completed 5 or more donations. Consistency is key!', 'criteria_type' => 'donation_count', 'criteria_value' => 5, 'min_points' => 0, 'display_order' => 6],
            ['code' => 'community_pillar', 'name' => 'Community Pillar', 'description' => 'Completed 20 or more donations. A pillar of our community.', 'criteria_type' => 'donation_count', 'criteria_value' => 20, 'min_points' => 0, 'display_order' => 7],
            ['code' => 'campaign_champion', 'name' => 'Campaign Champion', 'description' => 'Donated to 5 or more different campaigns. Spreading the love!', 'criteria_type' => 'campaign_count', 'criteria_value' => 5, 'min_points' => 0, 'display_order' => 8],
